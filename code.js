...
// 6. 6. You are given an array of objects representing data about developers who are attending a meetup.
...
let europeanGuests = guestList.filter((guest) => guest.continent === "Europe");
let answer6 = europeanGuests.length;
